...
#[derive(NavigationConvertible, Debug, Clone)]
enum Message {
    Username(String),
    Password(String),
    LoginRequest,
...
enum Page {
    #[page(
        title = "Login page",
        component = "login::LoginPage::new",
        settings = "login::page_setting"
    )]
    LoginPage,
...
pub mod login {
    ...
    use iced_navigation::{
        components::header::HeaderSettings, NavigationAction, NavigationConvertible, PageComponent,
    };
