...
mod app {
    ...
    impl TabsNavigatorMapper for Page {
        ...
        fn fa_icon(&self) -> Option<(&str, iced_font_awesome::IconFont)> {
            match self {
                Page::AticlePage => Some(("newspaper", iced_font_awesome::IconFont::Solid)),
                Page::ListPage => Some(("list", iced_font_awesome::IconFont::Solid)),
                Page::Settings => Some(("circle-user", iced_font_awesome::IconFont::Solid)),
            }
        }
